...
import com.demo.searchservice.exceptions.RestaurentNotFoundException;
...
//    }
	@GetMapping("/restaurants/{name}")
	@ExceptionHandler(RestaurentNotFoundException.class)
	public ResponseEntity<Restaurent> findRestaurant(@PathVariable(value="name") String name){
		
		Restaurent restaurent=resservice.getRestaurantByName(name);
